...
[1mFrom:[0m /mnt/c/Users/ariel/dev/flatiron/labs/rack-dynamic-routes-lab/app/application.rb:14 Application#call:
 ...
 => [1;34m14[0m:     binding.pry
    [1;34m15[0m:     variable = [36m@@items[0m.find{|i| i.name == item_name}
    [1;34m16[0m:     
    [1;34m17[0m:     resp.write variable.price
    [1;34m18[0m:   [32melse[0m
    [1;34m19[0m:     resp.write [31m[1;31m"[0m[31mRoute not found[1;31m"[0m[31m[0m
    [1;34m20[0m:     resp.status = [1;34m404[0m
    [1;34m21[0m:   [32mend[0m
    [1;34m22[0m:   
    [1;34m23[0m:   resp.finish
